...
trabajadas en tiempo regular y número de horas extra. 
La hora en tiempo regular se paga a 10$. y la hora en tiempo extra se paga a 25$. 
Se desea que el programa genere monto total pagado 
...
salida.innerHTML = "El monto total pagado por horas extras es: " + emp.devolvertotalhex()+ "$<br>";
salida.innerHTML += "El nombre del trabajador con menor sueldo obtendo es: " + emp.devolvernommenor()+ " con un salario de " + emp.devolvertotalmenor()+"$";